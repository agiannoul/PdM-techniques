...
class IndividualAnomalyTransductive:
    ...
    def __init__(self, w_martingale=15, non_conformity="median", k=20, dev_threshold=0.6, ref_group=["season-of-year"],
                 external_percentage=0.3, columns=None,R=1.5,thresOut=5,thresIn=30,metacheck=False):
    ...
    # ===========================================
    def plot_deviations(self, figsize=None, savefig=None, plots=["data", "strangeness", "pvalue", "deviation", "threshold"], debug=False,outl=[]):
